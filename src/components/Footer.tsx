...
export function Footer(){
    return (
      <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between sticky bottom-0">
        <div className='flex items-center gap-3'>
          <Image src="/album.jpg" width={56} height={56} alt="Capa do Álbum Travis Scott" />
          <div className='flex flex-col'>
            <strong className='font-normal'>Fein</strong>
